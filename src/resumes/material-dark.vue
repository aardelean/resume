...
<div class="resume">
  <div class="leftCol m_box">
    ...
    <div class="item" style="padding-top: 70px">
      <div class="section-headline">
        {{ lang.education }}
      </div>
      <div class="text">
        At {{ person.education.university }}
      </div>
      <div class="item last right" v-for="education in person.education.degrees" :key="education.degree">
        <div class="section-headline">{{education.degree}}</div>
        <div class="item text">
